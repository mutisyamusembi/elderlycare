...
$arrChartConfig = array(
    "chart" => array(
        "caption" => "Movement for Last 30 Days" ,
        "xAxisName" => "Date",
        "yAxisName" => "No. of devices",
        "rotatevalues" => "1",
        "theme" => "fusion",
        "lineThickness" => "2"
    )
...
$arrChartConfig["data"] =  $chart ;

// JSON Encode the data to retrieve the string containing the JSON representation of the data in the array.
$jsonEncodedData = json_encode($arrChartConfig);

// chart object
$Chart = new FusionCharts("line", "MyFirstChart" , "1200", "510", "chart-container", "json", $jsonEncodedData);
